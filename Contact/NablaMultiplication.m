function nabla_Sigma_n  = NablaMultiplication(NablaSigma,vec)
        ...
        % nabla_sigma_n = NablaSigma * vec1; % the first n (over the components of given by nabla) (n^t * nabla(Sigma) )
        ...
        nabla_Sigma_n  = NablaSigma_xi * vec(1) + NablaSigma_eta * vec(2);
