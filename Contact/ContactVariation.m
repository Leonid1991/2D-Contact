function [Fc,Kc,GapNab] = ContactVariation(Body1,Body2,penalty,approach,ContactForce,Gapfunc)
    ...
    if approach ~= 5 % all (Penalty & Nitsche approaches), but  Lagrange multiplier
